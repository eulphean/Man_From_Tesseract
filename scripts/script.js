...
/***/ "./node_modules/math-ds/build/math-ds.esm.js":
/*!***************************************************!*\
  !*** ./node_modules/math-ds/build/math-ds.esm.js ***!
  \***************************************************/
/*! exports provided: Box2, Box3, Cylindrical, Euler, Frustum, Line3, Matrix3, Matrix4, Plane, Quaternion, Ray, RotationOrder, Sphere, Spherical, SymmetricMatrix3, Vector2, Vector3, Vector4 */
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "RotationOrder", function() { return RotationOrder; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Sphere", function() { return Sphere; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Spherical", function() { return Spherical; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SymmetricMatrix3", function() { return SymmetricMatrix3; });
...
/*!**********************!*\
  !*** ./src/Agent.js ***!
  \**********************/
/*! exports provided: DIRECTION, Agent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var math_ds__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! math-ds */ "./node_modules/math-ds/build/math-ds.esm.js");
/* harmony import */ var _SparkUtility_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./SparkUtility.js */ "./src/SparkUtility.js");


const Diagnostics = __webpack_require__(/*! Diagnostics */ "Diagnostics");
...
class Agent {
    constructor(object, tesseracts, planes) {
        ...
        // Current position. 
        this.position = _SparkUtility_js__WEBPACK_IMPORTED_MODULE_1__["getLastPosition"](object);
        ...
        this.upVel = this.idx % 2 === 0 ? new math_ds__WEBPACK_IMPORTED_MODULE_0__["Vector3"](0, 0, -0.0025) : new math_ds__WEBPACK_IMPORTED_MODULE_0__["Vector3"](0, 0, -0.0015);
        this.downVel = this.idx % 2 === 0 ? new math_ds__WEBPACK_IMPORTED_MODULE_0__["Vector3"](0, 0, 0.0025) : new math_ds__WEBPACK_IMPORTED_MODULE_0__["Vector3"](0, 0, 0.0015);

        this.diff = new math_ds__WEBPACK_IMPORTED_MODULE_0__["Vector3"](0, 0, 0);
    }
    ...
    syncPosition() {
        _SparkUtility_js__WEBPACK_IMPORTED_MODULE_1__["syncSceneObject"](this.sceneObject, this.position);
    }

    resetRunner() {
        let length = this.tesseracts.length;
        // Find a new random index, anything except the current index. 
        let randIdx = _SparkUtility_js__WEBPACK_IMPORTED_MODULE_1__["random"](0, length - 1);
        while (randIdx === this.idx) {
            randIdx = _SparkUtility_js__WEBPACK_IMPORTED_MODULE_1__["random"](0, length - 1);
        }

        // Choose the tesseract or plane as the starting position
        let t = this.tesseracts[randIdx];
        let p = this.planes[randIdx];
        let d = _SparkUtility_js__WEBPACK_IMPORTED_MODULE_1__["random"](0, 1);; // 0 or 1 
        // Choose tesseract. 
        if (d === 0) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Plane", function() { return Plane; });
/* harmony import */ var _SparkUtility__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./SparkUtility */ "./src/SparkUtility.js");
...
class Plane {
    constructor(object) {
        this.position = _SparkUtility__WEBPACK_IMPORTED_MODULE_0__["getLastPosition"](object);
        this.idx = object.name.split('_')[1];
        // Note: Direction of plane is opposite of tesseract.
        this.direction = this.idx % 2 === 0 ? _Agent__WEBPACK_IMPORTED_MODULE_1__["DIRECTION"].UP : _Agent__WEBPACK_IMPORTED_MODULE_1__["DIRECTION"].DOWN;
    }
...
/*!*****************************!*\
  !*** ./src/SparkUtility.js ***!
  \*****************************/
/*! exports provided: getLastPosition, syncSceneObject, syncSceneObjectWorld, random */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getLastPosition", function() { return getLastPosition; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "syncSceneObject", function() { return syncSceneObject; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "syncSceneObjectWorld", function() { return syncSceneObjectWorld; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "random", function() { return random; });
/* harmony import */ var math_ds__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! math-ds */ "./node_modules/math-ds/build/math-ds.esm.js");

const Patches = __webpack_require__(/*! Patches */ "Patches");
const Reactive = __webpack_require__(/*! Reactive */ "Reactive");
...
const getLastPosition = sceneObject => {
    ...
    return new math_ds__WEBPACK_IMPORTED_MODULE_0__["Vector3"](posX, posY, posZ);
};
...
/*!**************************!*\
  !*** ./src/Tesseract.js ***!
  \**************************/
/*! exports provided: Tesseract */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Tesseract", function() { return Tesseract; });
/* harmony import */ var _SparkUtility__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./SparkUtility */ "./src/SparkUtility.js");
/* harmony import */ var _Agent__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Agent */ "./src/Agent.js");
...
class Tesseract {
    constructor(object) {
        ...
        this.direction = this.idx % 2 === 0 ? _Agent__WEBPACK_IMPORTED_MODULE_1__["DIRECTION"].DOWN : _Agent__WEBPACK_IMPORTED_MODULE_1__["DIRECTION"].UP;
...
/* harmony import */ var _Tesseract_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Tesseract.js */ "./src/Tesseract.js");
/* harmony import */ var _Plane_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Plane.js */ "./src/Plane.js");
/* harmony import */ var _Agent_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Agent.js */ "./src/Agent.js");
...
class World {
    ...
    setupTesseracts(sceneObjects) {
        ...
        this.objs.forEach(o => {
            let t = new _Tesseract_js__WEBPACK_IMPORTED_MODULE_0__["Tesseract"](o);
    ...
    setupPlanes(sceneObjects) {
        ...
        this.objs.forEach(o => {
            let p = new _Plane_js__WEBPACK_IMPORTED_MODULE_1__["Plane"](o);
            this.planes.push(p);
        });
    }
    ...
    setupAgents(sceneObjects) {
        ...
        this.objs.forEach(o => {
            let a = new _Agent_js__WEBPACK_IMPORTED_MODULE_2__["Agent"](o, this.tesseracts, this.planes);
            this.agents.push(a);
        });
    }
}
...
const Scene = __webpack_require__(/*! Scene */ "Scene");
const Diagnostics = __webpack_require__(/*! Diagnostics */ "Diagnostics");
const Time = __webpack_require__(/*! Time */ "Time");
...
Promise.all([Scene.root.findByPath('planeTracker/placer/Planes/*'), Scene.root.findByPath('planeTracker/placer/Tesseracts/*'), Scene.root.findByPath('planeTracker/placer/Runners/*')]).then(objects => {
    let sceneObjects = prepareSceneObjects(objects);

    // Setup agents, octree, etc. 
    world = new _World_js__WEBPACK_IMPORTED_MODULE_0__["World"](sceneObjects);
